    ...
    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
      ...
      <ul class="chat-list">
        <li class="list active">
          <div class="profile"><img src="<?= base_url() ?>assets/images/faces/face1.jpg" alt="image"><span class="online"></span>
          </div>
          <div class="info">
            <p>Thomas Douglas</p>
            <p>Available</p>
        ...
        <li class="list">
          <div class="profile"><img src="<?= base_url() ?>assets/images/faces/face2.jpg" alt="image"><span class="offline"></span>
          </div>
          <div class="info">
        ...
        <li class="list">
          <div class="profile"><img src="<?= base_url() ?>assets/images/faces/face3.jpg" alt="image"><span class="online"></span>
          </div>
          <div class="info">
            <p>Daniel Russell</p>
            <p>Available</p>
        ...
        <li class="list">
          <div class="profile"><img src="<?= base_url() ?>assets/images/faces/face4.jpg" alt="image"><span class="offline"></span>
          </div>
          <div class="info">
        ...
        <li class="list">
          <div class="profile"><img src="<?= base_url() ?>assets/images/faces/face5.jpg" alt="image"><span class="online"></span>
          </div>
          <div class="info">
        ...
        <li class="list">
          <div class="profile"><img src="<?= base_url() ?>assets/images/faces/face6.jpg" alt="image"><span class="online"></span>
          </div>
          <div class="info">
            <p>Sarah Graves</p>
            <p>Available</p>
                                  ...
                                  <div class="col-lg-12">
                                    ...
                                    <div class="mt-3">
                                      <div
                                        ...
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="<?= base_url() ?>assets/images/faces/face1.jpg"
                                            alt="profile">
                                      ...
                                      <div
                                        class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="<?= base_url() ?>assets/images/faces/face2.jpg"
                                            alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div
                                        class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="<?= base_url() ?>assets/images/faces/face3.jpg"
                                            alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div
                                        class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="<?= base_url() ?>assets/images/faces/face4.jpg"
                                            alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="<?= base_url() ?>assets/images/faces/face5.jpg"
                                            alt="profile">
                                          <div class="wrapper ms-3">
